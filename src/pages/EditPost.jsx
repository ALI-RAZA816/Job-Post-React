// Import React and useContext for accessing the AppContext
import React, { useContext } from 'react'

// Import custom CSS module for styling the EditPost component
...
// Import AppContext to get state and handlers for editing
import { AppContext } from '../context/AppContext';

export default function EditPost() {
    // Define static arrays for job types and benefit options
    ...
    // Destructure all needed state variables and handlers from AppContext
    const {
        editjobtitle,
        editcompanyname,
        editlocation,
        ...
        <section>
            <div className="container">
                <div className="row py-5">
                        ...
                        <form action="">
                                ...
                                <div className="row p-0">
                                    ...
                                    <div className="col-md-6 mb-4">
                                        ...
                                        <input
                                            ...
                                            onChange={editcompanynamehandler}
                            ...
                            <div className={`${style.job_description} rounded-3 p-4 mt-5`}>
                                ...
                                <div>
                                    ...
                                    {/* Skills input container with dynamic tags */}
                                    <div
                                        className='d-flex py-2 overflow-hidden flex-wrap align-items-center px-2 rounded-3'
                                    ...
                                    >
                                        ...
                                        {editarrskills.map((item, index) => {
                                            return (
                                                <span key={index} className='me-2 text-nowrap  my-1 mt-md-0'>
                                                    {item}
                                                    <RxCross2
                                                        onClick={() => deleteeditskillhandler(index)}
                                        ...
                                        <input
                                            ...
                                            ref={editskills}
                                            onKeyDown={geteditskilllhandler}
                                            type="text"
                                            placeholder='Add skills...'
                                            className={`${editarrskills.length === 6 ? 'd-none' : 'd-block'} w-100 border-0 form-control`}
                                        />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div className='row p-0 g-0'>
                                                {/* Render checkboxes for benefits; checked state uses lowercased comparison */}
                                                    ...
                                                    return (
                                                        <div key={item} className="col-md-3 form-check form-check-inline">
                                                            <input
                                                                ...
                                                                checked={editadditional.includes(item.toLowerCase())}
                                                                onChange={editadditionalhandler}
                                                                type="checkbox"
                                                                value={item}
                                                                id={item}
                                                            />
                    ...
                    {/* Right column: Post Preview and action buttons */}
                    <div className="col-xl-4">
                        <div className='p-md-3 mt-4 mt-md-0'>
                            <div className={`${style.job_preview} p-4 rounded-3`}>
                                ...
                                {/* Preview card showing the job details as they'll appear */}
                                <div className={`${style.preview_detail} p-4 rounded-3`}>
                                    ...
                                    <div className='py-3 d-flex flex-wrap align-items-center border border-secondary border-start-0 border-top-0 border-end-0'>
                                        <span className='fw-normal me-5 d-flex align-items-center'>
                                            <CiLocationOn className='me-1' /> {editlocation ? editlocation : 'Location'}
                                        </span>
                                        <span className='fw-normal me-5 d-flex align-items-center'>
                                            <CiClock2 className='me-1' /> {editjobtype ? editjobtype : 'Job Type'}
                                        </span>
                                        <span className='fw-normal d-flex align-items-center'>
                                            <HiOutlineCurrencyDollar className='me-1' /> ${editminsalary ? editminsalary : '0'}k - ${editmaxsalary ? editmaxsalary : '0'}k
                                        </span>
                                    </div>
                                    <a href="" className='d-inline-block mt-2' style={{ color: '#27e0a6', fontSize: '14px' }}>View Details</a>
                                </div>
                                {/* Action buttons: Edit Post and Save as Draft */}
