            ...
            <div className='container'>
                <div className="row">
                    <div className={`col-md-6 ${style.right_box}`}>
                        <div>
                            <h1 style={{fontSize:'3rem'}} className='text-white fw-bold'>The Bridge Between <span style={{color:'#DAE2FD'}}>Top Tech</span> Talent and Global Opportunities.</h1>
            ...
            <div className="container">
                <div className="row">
                    <div className={`col-12 d-flex text-center ${style.content} justify-content-center align-items-center flex-column`}>
                        ...
                        <p className='fs-5 text-center'>Whether you're scaling an engineering team or looking for your next challenge, DevConnect <br className='d-none d-lg-block' /> is the specialized platform for your success.</p>
                        <div className='mt-4'>
